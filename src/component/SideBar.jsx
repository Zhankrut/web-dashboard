...
function SideBar() {
  return (
    <aside className="flex flex-col justify-between w-80 bg-gray-800 min-h-screen border border-gray-900 z-10 shadow shadow-gray-600">

      <div className="py-3 text-2xl uppercase text-center tracking-widest bg-gray-900 border-b-2 border-gray-800 ">
