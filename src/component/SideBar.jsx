...
function SideBar() {
  return (
    <aside className="flex flex-col justify-between w-80 bg-gray-800 h-screen border border-gray-900 z-10 shadow shadow-gray-600">
      ...
      <nav className="text-sm h-full text-gray-300">
        <ul className="flex flex-col">
          <li className="px-4 cursor-pointer hover:bg-gray-700  hover:text-white">
            <NavLink className="py-3 flex items-center" href="/">
          ...
          <li className="cursor-pointer hover:bg-gray-700">
            <NavLink className={(isActive) => (isActive ? 'py-3 bg-red-400' : 'py-3')} href="/">
